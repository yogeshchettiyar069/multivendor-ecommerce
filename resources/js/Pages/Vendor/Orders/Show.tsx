            ...
            <div className="mx-auto max-w-5xl space-y-6 px-4 py-8 duration-500 animate-in fade-in slide-in-from-bottom-2 sm:px-6 lg:px-8">
                ...
                <Card>
                    ...
                    <CardContent className="flex flex-col gap-3 sm:flex-row sm:items-center">
                        ...
                        <Button
                            onClick={update}
                            disabled={working || stage === order.tracking_status}
                        >
                            Update status
                        </Button>
                        <p className="text-xs text-muted-foreground">
                            Marking <span className="font-medium">Delivered</span> completes the
                            order and releases your payout.
                        </p>
                    </CardContent>
                </Card>
                            ...
                            <CardContent className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold">
                                        {formatCents(order.my_revenue_cents)}
                                    </span>
                                </div>
                                <div className="flex justify-between">
